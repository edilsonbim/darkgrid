...
contextBridge.exposeInMainWorld('darkGridAPI', {
  ...
  saveDiscordWebhook: (webhookUrl) => ipcRenderer.invoke('discord:save', webhookUrl),
  clearDiscordWebhook: () => ipcRenderer.invoke('discord:clear'),
  ...
  setAccountMaximized: (id) => ipcRenderer.invoke('account:maximized', id),
  setAccountZoom: (id, factor) => ipcRenderer.invoke('account:zoom', id, factor),
