...
function openHunt(account) { huntAccount = account; $('#huntAccountLabel').textContent = account.name || 'Conta selecionada'; $('#huntSlug').value = account.huntSlug || ''; $('#huntName').value = account.hunt || ''; $('#huntError').textContent = ''; $('#huntModal').hidden = false; $('#huntSlug').focus(); }
